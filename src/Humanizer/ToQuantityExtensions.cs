...
namespace Humanizer
{
    ...
    public static class ToQuantityExtensions
    {
        ...
        /// </example>
        /// <returns></returns>
        public static string ToQuantity(this string input, decimal quantity, string format = null, IFormatProvider formatProvider = null)
        {
            var transformedInput = quantity == 1
                ? input.Singularize(inputIsKnownToBePlural: false)
                : input.Pluralize(inputIsKnownToBeSingular: false);
        ...
        public static string ToQuantity(this string input, decimal quantity)
        {
            return ToQuantity(input, quantity, null, null);
        }
    }
